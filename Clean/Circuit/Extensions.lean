...
def computeValueFromOffset (α : TypeMap) [ProvableType α] (offset : ℕ) (env : ProverEnvironment F) : α F :=
...
theorem ProvableType.witnessAny.localWitnesses (n : ℕ) (env : ProverEnvironment F) :
