...
def theta_c (state : Vector ℕ 25) : Vector ℕ 5 :=
    #v[
      (state.get 0) ^^^ (state.get 1) ^^^ (state.get 2) ^^^ (state.get 3) ^^^ (state.get 4),
      (state.get 5) ^^^ (state.get 6) ^^^ (state.get 7) ^^^ (state.get 8) ^^^ (state.get 9),
      (state.get 10) ^^^ (state.get 11) ^^^ (state.get 12) ^^^ (state.get 13) ^^^ (state.get 14),
      (state.get 15) ^^^ (state.get 16) ^^^ (state.get 17) ^^^ (state.get 18) ^^^ (state.get 19),
      (state.get 20) ^^^ (state.get 21) ^^^ (state.get 22) ^^^ (state.get 23) ^^^ (state.get 24)
    ]

def theta_d (c : Vector ℕ 5) : Vector ℕ 5 :=
  #v[
    (c.get 4) ^^^ (rol_u64 (c.get 1) 1),
    (c.get 0) ^^^ (rol_u64 (c.get 2) 1),
    (c.get 1) ^^^ (rol_u64 (c.get 3) 1),
    (c.get 2) ^^^ (rol_u64 (c.get 4) 1),
    (c.get 3) ^^^ (rol_u64 (c.get 0) 1)
  ]
...
def theta_xor (state : Vector ℕ 25) (d : Vector ℕ 5) : Vector ℕ 25 :=
  #v[
    ...
    (state.get 8) ^^^ (d.get 1),
    (state.get 9) ^^^ (d.get 1),
    (state.get 10) ^^^ (d.get 2),
    (state.get 11) ^^^ (d.get 2),
    (state.get 12) ^^^ (d.get 2),
    (state.get 13) ^^^ (d.get 2),
    (state.get 14) ^^^ (d.get 2),
    (state.get 15) ^^^ (d.get 3),
    (state.get 16) ^^^ (d.get 3),
    (state.get 17) ^^^ (d.get 3),
    (state.get 18) ^^^ (d.get 3),
    (state.get 19) ^^^ (d.get 3),
    (state.get 20) ^^^ (d.get 4),
    (state.get 21) ^^^ (d.get 4),
    (state.get 22) ^^^ (d.get 4),
    (state.get 23) ^^^ (d.get 4),
    (state.get 24) ^^^ (d.get 4)
  ]
...
def chi (b : Vector ℕ 25) : Vector ℕ 25 :=
  #v[
    (b.get 0) ^^^ ((not_u64 (b.get 5)) &&& (b.get 10)),
    (b.get 1) ^^^ ((not_u64 (b.get 6)) &&& (b.get 11)),
    (b.get 2) ^^^ ((not_u64 (b.get 7)) &&& (b.get 12)),
    (b.get 3) ^^^ ((not_u64 (b.get 8)) &&& (b.get 13)),
    (b.get 4) ^^^ ((not_u64 (b.get 9)) &&& (b.get 14)),
    (b.get 5) ^^^ ((not_u64 (b.get 10)) &&& (b.get 15)),
    (b.get 6) ^^^ ((not_u64 (b.get 11)) &&& (b.get 16)),
    (b.get 7) ^^^ ((not_u64 (b.get 12)) &&& (b.get 17)),
    (b.get 8) ^^^ ((not_u64 (b.get 13)) &&& (b.get 18)),
    (b.get 9) ^^^ ((not_u64 (b.get 14)) &&& (b.get 19)),
    (b.get 10) ^^^ ((not_u64 (b.get 15)) &&& (b.get 20)),
    (b.get 11) ^^^ ((not_u64 (b.get 16)) &&& (b.get 21)),
    (b.get 12) ^^^ ((not_u64 (b.get 17)) &&& (b.get 22)),
    (b.get 13) ^^^ ((not_u64 (b.get 18)) &&& (b.get 23)),
    (b.get 14) ^^^ ((not_u64 (b.get 19)) &&& (b.get 24)),
    (b.get 15) ^^^ ((not_u64 (b.get 20)) &&& (b.get 0)),
    (b.get 16) ^^^ ((not_u64 (b.get 21)) &&& (b.get 1)),
    (b.get 17) ^^^ ((not_u64 (b.get 22)) &&& (b.get 2)),
    (b.get 18) ^^^ ((not_u64 (b.get 23)) &&& (b.get 3)),
    (b.get 19) ^^^ ((not_u64 (b.get 24)) &&& (b.get 4)),
    (b.get 20) ^^^ ((not_u64 (b.get 0)) &&& (b.get 5)),
    (b.get 21) ^^^ ((not_u64 (b.get 1)) &&& (b.get 6)),
    (b.get 22) ^^^ ((not_u64 (b.get 2)) &&& (b.get 7)),
    (b.get 23) ^^^ ((not_u64 (b.get 3)) &&& (b.get 8)),
    (b.get 24) ^^^ ((not_u64 (b.get 4)) &&& (b.get 9))
  ]
