...
theorem orchardActionPinnedCS_prefix_matches_rust :
    ((Halo2.Pinned.Debug.constraintSystem Halo2.Orchard.Action.plonkCircuitPinnedCS).take 319000 ==
      Halo2.Fixtures.RustPinnedCS.orchardAction.take 319000) = true := by
  native_decide
