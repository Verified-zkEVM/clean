...
def circuit : FormalAssertion Fp Row where
  ...
  soundness := by
    ...
    exact spec_of_eqs
      ⟨input_pkdX, input_b3, input_d0, input_c, input_b3C', input_z13C, input_z14B3C'⟩
      h_assumptions hrec hg1 hg2
  completeness := by
    circuit_proof_start
    exact eqs_of_spec
      ⟨input_pkdX, input_b3, input_d0, input_c, input_b3C', input_z13C, input_z14B3C'⟩
...
def circuit : FormalAssertion Fp Row where
  ...
  soundness := by
    ...
    obtain ⟨hrec, _, hg1, hg2⟩ := h_holds
    exact spec_of_eqs
      ⟨input_rho, input_e1, input_g0, input_f, input_e1F', input_z13F, input_z14E1F'⟩
      h_assumptions hrec hg1 hg2
  completeness := by
    circuit_proof_start
    exact eqs_of_spec
...
def circuit : FormalAssertion Fp Row where
  ...
  soundness := by
    ...
    exact spec_of_eqs
      ⟨input_psi, input_h0, input_g1, input_h1, input_g2, input_g1G2', input_z13G,
        input_z13G1G2'⟩
      h_assumptions hrec hg_h0 hg_z13 hg_z13p
  completeness := by
    circuit_proof_start
    exact eqs_of_spec
      ⟨input_psi, input_h0, input_g1, input_h1, input_g2, input_g1G2', input_z13G,
...
def circuit : FormalAssertion Fp Row where
  ...
  soundness := by
    ...
    exact spec_of_eqs
      ⟨input_y, input_lsb, input_k0, input_k2, input_k3, input_j, input_z1J,
        input_z13J, input_j', input_z13J'⟩
      h_assumptions hk3 hj_dec hrec hg1 hg3
  completeness := by
    circuit_proof_start [tP]
    exact eqs_of_spec
      ⟨input_y, input_lsb, input_k0, input_k2, input_k3, input_j, input_z1J,
