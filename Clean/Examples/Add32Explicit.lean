...
example (x0 x1 x2 x3 y0 y1 y2 y3 carryIn : Var field (F pBabybear)) env (i0 : ℕ) :
  ...
  ↔
  (ZMod.val (env.tape.get i0) < 256 ∧ IsBool (env.tape.get (i0 + 1)) ∧
    Expression.eval env.tape x0 + Expression.eval env.tape y0 + Expression.eval env.tape carryIn + -env.tape.get i0 + -(env.tape.get (i0 + 1) * 256) = 0) ∧
  (ZMod.val (env.tape.get (i0 + 2)) < 256 ∧ IsBool (env.tape.get (i0 + 3)) ∧
    Expression.eval env.tape x1 + Expression.eval env.tape y1 + env.tape.get (i0 + 1) + -env.tape.get (i0 + 2) + -(env.tape.get (i0 + 3) * 256) = 0) ∧
  (ZMod.val (env.tape.get (i0 + 4)) < 256 ∧ IsBool (env.tape.get (i0 + 5)) ∧
    Expression.eval env.tape x2 + Expression.eval env.tape y2 + env.tape.get (i0 + 3) + -env.tape.get (i0 + 4) + -(env.tape.get (i0 + 5) * 256) = 0) ∧
  (ZMod.val (env.tape.get (i0 + 6)) < 256 ∧ IsBool (env.tape.get (i0 + 7)) ∧
    Expression.eval env.tape x3 + Expression.eval env.tape y3 + env.tape.get (i0 + 5) + -env.tape.get (i0 + 6) + -(env.tape.get (i0 + 7) * 256) = 0) := by
