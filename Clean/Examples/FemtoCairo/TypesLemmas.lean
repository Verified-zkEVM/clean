...
@[circuit_norm]
lemma State.eval_pc (env : ProverEnvironment F) (s : Var State F) :
...
@[circuit_norm]
lemma State.eval_ap (env : ProverEnvironment F) (s : Var State F) :
...
@[circuit_norm]
lemma State.eval_fp (env : ProverEnvironment F) (s : Var State F) :
...
@[circuit_norm]
lemma RawInstruction.eval_rawInstrType (env : ProverEnvironment F) (r : Var RawInstruction F) :
...
@[circuit_norm]
lemma RawInstruction.eval_op1 (env : ProverEnvironment F) (r : Var RawInstruction F) :
...
@[circuit_norm]
lemma RawInstruction.eval_op2 (env : ProverEnvironment F) (r : Var RawInstruction F) :
...
@[circuit_norm]
lemma RawInstruction.eval_op3 (env : ProverEnvironment F) (r : Var RawInstruction F) :
