...
and Sinsemilla domain points: the six certified bases (`Halo2.Ironwood.Ecc.MulFixed.Certs`)
...
def merkleQ : Halo2.Ironwood.Point Halo2.Ironwood.Fp :=
...
def ivkQ : Halo2.Ironwood.Point Halo2.Ironwood.Fp :=
...
def noteQ : Halo2.Ironwood.Point Halo2.Ironwood.Fp :=
...
def orchardBases : Circuit.Bases where
  nullifierK := Halo2.Ironwood.Ecc.MulFixed.Certs.nullifierK
  valueCommitV := Halo2.Ironwood.Ecc.MulFixed.Certs.valueCommitV
  valueCommitR := Halo2.Ironwood.Ecc.MulFixed.Certs.valueCommitR
  spendAuthG := Halo2.Ironwood.Ecc.MulFixed.Certs.spendAuthG
  commitIvkR := Halo2.Ironwood.Ecc.MulFixed.Certs.commitIvkR
  noteCommitR := Halo2.Ironwood.Ecc.MulFixed.Certs.noteCommitR
  merkleQ := merkleQ
...
def orchardActionCircuit :
    FormalCircuit Halo2.Ironwood.Fp Unit Circuit.Config Circuit.PrivateInputs unit :=
  Circuit.circuit Halo2.Ironwood.Specs.Sinsemilla.orchardGenerators orchardBases
