...
import Clean.Ironwood.Fixtures.SinsemillaPre
import Clean.Ironwood.Fixtures.SinsemillaPost
import Clean.Ironwood.Fixtures.SinsemillaSelMap
...
def sinsemillaS0 : Halo2.Ironwood.Point Fp :=
...
theorem sinsemillaS0_onCurve : sinsemillaS0.OnCurve := by
  show sinsemillaS0.y ^ 2 = sinsemillaS0.x ^ 3 + Halo2.Ironwood.pallasB
  decide
