...
pub use common::{CommonData, ProverData, ProverOnlyData, PublicLookup, get_perm_challenges};
pub use config::{
...
pub use prover::{StarkInstance, prove_batch, prove_batch_with_public_lookups};
pub use verifier::{verify_batch, verify_batch_with_public_lookups};
